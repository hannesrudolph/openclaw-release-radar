...
function closureStatusRank(status: string): number {
  return ({
    ...
    fixed_after_release: 2,
    duplicate_to_fixed_after_release: 3,
    main_only_claim: 4,
    already_present_claim: 5,
    duplicate_to_closed_canonical: 6,
    canonical_cycle_or_self_reference: 7,
    duplicate_or_superseded: 8,
    repro_requested: 9,
    no_code_proof: 10,
    no_timeline_event: 11,
    reporter_replaced: 12,
    reporter_withdrawn: 13,
    reporter_self_closed: 14,
    not_planned: 15,
    non_bug_neutral: 16,
    duplicate_to_fixed_in_release: 17,
    fixed_in_release: 18,
