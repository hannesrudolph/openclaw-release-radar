...
function closureStatusRank(status: string): number {
  return ({
    ...
    non_bug_duplicate_to_open_canonical: 20,
    non_bug_superseded_to_open_pr: 21,
    non_bug_duplicate_with_open_pr_context: 22,
    non_bug_duplicate_to_fixed_after_release: 23,
