...
function closureStatusRank(status: string): number {
  return ({
    ...
    fixed_after_release: 3,
    duplicate_to_fixed_after_release: 4,
    main_only_claim: 5,
    already_present_claim: 6,
    admin_not_planned_unverified: 7,
    duplicate_to_closed_canonical_missing_proof: 8,
    duplicate_to_closed_canonical: 9,
    canonical_cycle_or_self_reference: 10,
    duplicate_or_superseded: 11,
    repro_requested: 12,
    linked_closing_pr_reachability_unknown: 13,
    linked_closing_pr_not_merged: 14,
    related_pr_without_release_fix: 15,
    closed_without_release_fix_proof: 16,
    no_code_proof: 17,
    no_timeline_event: 18,
    reporter_replaced: 19,
    reporter_withdrawn: 20,
    reporter_self_closed: 21,
    non_bug_fixed_after_release: 22,
    non_bug_linked_without_merge: 23,
    non_bug_duplicate_to_open_canonical: 24,
    non_bug_superseded_to_open_pr: 25,
    non_bug_duplicate_with_open_pr_context: 26,
    non_bug_duplicate_to_fixed_after_release: 27,
    non_bug_duplicate_to_closed_canonical_missing_proof: 28,
    non_bug_duplicate_to_closed_canonical: 29,
    non_bug_duplicate_or_superseded: 30,
    non_bug_not_actionable: 31,
    not_planned: 32,
    non_bug_neutral: 33,
    non_bug_duplicate_to_fixed_in_release: 34,
    non_bug_fixed_in_release: 35,
    duplicate_to_fixed_in_release: 36,
    fixed_in_release: 37,
