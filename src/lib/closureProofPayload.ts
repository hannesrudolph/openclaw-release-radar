...
function closureStatusRank(status: string): number {
  return ({
    ...
    duplicate_to_closed_canonical_missing_proof: 16,
    duplicate_to_unverified_closed_canonical: 17,
    duplicate_to_known_not_in_release_canonical: 18,
    duplicate_to_open_pr_canonical: 19,
    duplicate_to_closed_canonical: 20,
    duplicate_to_non_actionable_canonical: 21,
    canonical_cycle_or_self_reference: 22,
    duplicate_or_superseded: 23,
    repro_requested: 24,
    insufficient_info: 25,
    linked_closing_pr_reachability_unknown: 26,
    related_merged_pr_reachability_unknown: 27,
    not_planned_related_merged_pr_reachability_unknown: 28,
    linked_closing_pr_closed_unmerged: 29,
    linked_closing_pr_not_merged: 30,
    not_planned_linked_pr_not_merged: 31,
    related_closed_unmerged_pr_context: 32,
    not_planned_related_closed_unmerged_pr_context: 33,
    external_repo_closing_pr_unscored: 34,
    related_merged_pr_reachable_context_without_fix_credit: 35,
    not_planned_related_merged_pr_reachable_context_without_fix_credit: 36,
    related_pr_without_release_fix: 37,
    not_planned_related_pr_without_release_fix: 38,
    closed_without_release_fix_proof: 39,
    no_code_proof: 40,
    no_timeline_event: 41,
    reporter_replaced: 42,
    reporter_withdrawn: 43,
    reporter_self_closed: 44,
    non_bug_fixed_after_release: 45,
    non_bug_fixed_not_in_scored_releases: 46,
    non_bug_fixed_in_later_release: 47,
    non_bug_linked_without_merge: 48,
    non_bug_linked_pr_open: 49,
    non_bug_linked_pr_closed_unmerged: 50,
    non_bug_duplicate_to_open_canonical: 51,
    non_bug_superseded_to_open_pr: 52,
    non_bug_duplicate_with_open_pr_context: 53,
    non_bug_duplicate_to_fixed_after_release: 54,
    non_bug_duplicate_to_closed_canonical_missing_proof: 55,
    non_bug_duplicate_to_closed_canonical: 56,
    non_bug_duplicate_or_superseded: 57,
    non_bug_not_actionable: 58,
    not_planned: 59,
    non_bug_neutral: 60,
    non_bug_duplicate_to_fixed_in_release: 61,
    non_bug_fixed_in_release: 62,
    not_planned_with_release_fix_proof: 63,
    duplicate_to_fixed_in_release: 64,
    fixed_in_release: 65,
