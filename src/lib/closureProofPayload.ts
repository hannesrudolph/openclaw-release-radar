...
function closureStatusRank(status: string): number {
  return ({
    ...
    main_only_claim: 13,
    already_present_claim: 14,
    admin_not_planned_unverified: 15,
    admin_not_planned_no_context: 16,
    duplicate_to_closed_canonical_missing_proof: 17,
    duplicate_to_unverified_closed_canonical: 18,
    duplicate_to_known_not_in_release_canonical: 19,
    duplicate_to_open_pr_canonical: 20,
    duplicate_to_closed_canonical: 21,
    duplicate_to_non_actionable_canonical: 22,
    canonical_cycle_or_self_reference: 23,
    duplicate_or_superseded: 24,
    repro_requested: 25,
    insufficient_info: 26,
    linked_closing_pr_reachability_unknown: 27,
    related_merged_pr_reachability_unknown: 28,
    not_planned_related_merged_pr_reachability_unknown: 29,
    linked_closing_pr_closed_unmerged: 30,
    linked_closing_pr_not_merged: 31,
    not_planned_linked_pr_not_merged: 32,
    related_closed_unmerged_pr_context: 33,
    not_planned_related_closed_unmerged_pr_context: 34,
    external_repo_closing_pr_unscored: 35,
    related_merged_pr_reachable_context_without_fix_credit: 36,
    not_planned_related_merged_pr_reachable_context_without_fix_credit: 37,
    related_pr_without_release_fix: 38,
    not_planned_related_pr_without_release_fix: 39,
    closed_without_release_fix_proof: 40,
    no_code_proof: 41,
    no_timeline_event: 42,
    reporter_replaced: 43,
    reporter_withdrawn: 44,
    reporter_self_closed: 45,
    non_bug_fixed_after_release: 46,
    non_bug_fixed_not_in_scored_releases: 47,
    non_bug_fixed_in_later_release: 48,
    non_bug_linked_without_merge: 49,
    non_bug_linked_pr_open: 50,
    non_bug_linked_pr_closed_unmerged: 51,
    non_bug_duplicate_to_open_canonical: 52,
    non_bug_superseded_to_open_pr: 53,
    non_bug_duplicate_with_open_pr_context: 54,
    non_bug_duplicate_to_fixed_after_release: 55,
    non_bug_duplicate_to_closed_canonical_missing_proof: 56,
    non_bug_duplicate_to_closed_canonical: 57,
    non_bug_duplicate_or_superseded: 58,
    non_bug_not_actionable: 59,
    not_planned: 60,
    non_bug_neutral: 61,
    non_bug_duplicate_to_fixed_in_release: 62,
    non_bug_fixed_in_release: 63,
    not_planned_with_release_fix_proof: 64,
    duplicate_to_fixed_in_release: 65,
    fixed_in_release: 66,
