...
function closureStatusRank(status: string): number {
  return ({
    ...
    duplicate_to_closed_canonical: 8,
    canonical_cycle_or_self_reference: 9,
    duplicate_or_superseded: 10,
    repro_requested: 11,
    no_code_proof: 12,
    no_timeline_event: 13,
    reporter_replaced: 14,
    reporter_withdrawn: 15,
    reporter_self_closed: 16,
    not_planned: 17,
    non_bug_neutral: 18,
    duplicate_to_fixed_in_release: 19,
    fixed_in_release: 20,
