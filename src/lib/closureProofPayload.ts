...
function closureStatusRank(status: string): number {
  return ({
    ...
    fixed_not_in_scored_releases: 5,
    fixed_in_later_release: 6,
    fixed_after_release: 7,
    duplicate_to_fixed_after_release: 8,
    not_planned_fixed_after_release: 9,
    main_only_claim: 10,
    already_present_claim: 11,
    admin_not_planned_unverified: 12,
    duplicate_to_closed_canonical_missing_proof: 13,
    duplicate_to_unverified_closed_canonical: 14,
    duplicate_to_known_not_in_release_canonical: 15,
    duplicate_to_open_pr_canonical: 16,
    duplicate_to_closed_canonical: 17,
    duplicate_to_non_actionable_canonical: 18,
    canonical_cycle_or_self_reference: 19,
    duplicate_or_superseded: 20,
    repro_requested: 21,
    linked_closing_pr_reachability_unknown: 22,
    linked_closing_pr_closed_unmerged: 23,
    linked_closing_pr_not_merged: 24,
    not_planned_linked_pr_not_merged: 25,
    related_pr_without_release_fix: 26,
    not_planned_related_pr_without_release_fix: 27,
    closed_without_release_fix_proof: 28,
    no_code_proof: 29,
    no_timeline_event: 30,
    reporter_replaced: 31,
    reporter_withdrawn: 32,
    reporter_self_closed: 33,
    non_bug_fixed_after_release: 34,
    non_bug_fixed_not_in_scored_releases: 35,
    non_bug_fixed_in_later_release: 36,
    non_bug_linked_without_merge: 37,
    non_bug_linked_pr_open: 38,
    non_bug_linked_pr_closed_unmerged: 39,
    non_bug_duplicate_to_open_canonical: 40,
    non_bug_superseded_to_open_pr: 41,
    non_bug_duplicate_with_open_pr_context: 42,
    non_bug_duplicate_to_fixed_after_release: 43,
    non_bug_duplicate_to_closed_canonical_missing_proof: 44,
    non_bug_duplicate_to_closed_canonical: 45,
    non_bug_duplicate_or_superseded: 46,
    non_bug_not_actionable: 47,
    not_planned: 48,
    non_bug_neutral: 49,
    non_bug_duplicate_to_fixed_in_release: 50,
    non_bug_fixed_in_release: 51,
    not_planned_with_release_fix_proof: 52,
    duplicate_to_fixed_in_release: 53,
    fixed_in_release: 54,
