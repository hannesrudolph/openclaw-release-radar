...
function closureStatusRank(status: string): number {
  return ({
    ...
    duplicate_to_closed_canonical: 11,
    canonical_cycle_or_self_reference: 12,
    duplicate_or_superseded: 13,
    repro_requested: 14,
    linked_closing_pr_reachability_unknown: 15,
    linked_closing_pr_not_merged: 16,
    not_planned_linked_pr_not_merged: 17,
    related_pr_without_release_fix: 18,
    not_planned_related_pr_without_release_fix: 19,
    closed_without_release_fix_proof: 20,
    no_code_proof: 21,
    no_timeline_event: 22,
    reporter_replaced: 23,
    reporter_withdrawn: 24,
    reporter_self_closed: 25,
    non_bug_fixed_after_release: 26,
    non_bug_linked_without_merge: 27,
    non_bug_duplicate_to_open_canonical: 28,
    non_bug_superseded_to_open_pr: 29,
    non_bug_duplicate_with_open_pr_context: 30,
    non_bug_duplicate_to_fixed_after_release: 31,
    non_bug_duplicate_to_closed_canonical_missing_proof: 32,
    non_bug_duplicate_to_closed_canonical: 33,
    non_bug_duplicate_or_superseded: 34,
    non_bug_not_actionable: 35,
    not_planned: 36,
    non_bug_neutral: 37,
    non_bug_duplicate_to_fixed_in_release: 38,
    non_bug_fixed_in_release: 39,
    not_planned_with_release_fix_proof: 40,
    duplicate_to_fixed_in_release: 41,
    fixed_in_release: 42,
