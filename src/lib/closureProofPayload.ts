...
function closureStatusRank(status: string): number {
  return ({
    ...
    fixed_after_release: 4,
    duplicate_to_fixed_after_release: 5,
    not_planned_fixed_after_release: 6,
    main_only_claim: 7,
    already_present_claim: 8,
    admin_not_planned_unverified: 9,
    duplicate_to_closed_canonical_missing_proof: 10,
    duplicate_to_unverified_closed_canonical: 11,
    duplicate_to_known_not_in_release_canonical: 12,
    duplicate_to_open_pr_canonical: 13,
    duplicate_to_closed_canonical: 14,
    duplicate_to_non_actionable_canonical: 15,
    canonical_cycle_or_self_reference: 16,
    duplicate_or_superseded: 17,
    repro_requested: 18,
    linked_closing_pr_reachability_unknown: 19,
    linked_closing_pr_not_merged: 20,
    not_planned_linked_pr_not_merged: 21,
    related_pr_without_release_fix: 22,
    not_planned_related_pr_without_release_fix: 23,
    closed_without_release_fix_proof: 24,
    no_code_proof: 25,
    no_timeline_event: 26,
    reporter_replaced: 27,
    reporter_withdrawn: 28,
    reporter_self_closed: 29,
    non_bug_fixed_after_release: 30,
    non_bug_linked_without_merge: 31,
    non_bug_duplicate_to_open_canonical: 32,
    non_bug_superseded_to_open_pr: 33,
    non_bug_duplicate_with_open_pr_context: 34,
    non_bug_duplicate_to_fixed_after_release: 35,
    non_bug_duplicate_to_closed_canonical_missing_proof: 36,
    non_bug_duplicate_to_closed_canonical: 37,
    non_bug_duplicate_or_superseded: 38,
    non_bug_not_actionable: 39,
    not_planned: 40,
    non_bug_neutral: 41,
    non_bug_duplicate_to_fixed_in_release: 42,
    non_bug_fixed_in_release: 43,
    not_planned_with_release_fix_proof: 44,
    duplicate_to_fixed_in_release: 45,
    fixed_in_release: 46,
