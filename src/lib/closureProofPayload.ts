...
function closureStatusRank(status: string): number {
  return ({
    ...
    duplicate_to_closed_canonical: 7,
    canonical_cycle_or_self_reference: 8,
    duplicate_or_superseded: 9,
    repro_requested: 10,
    no_code_proof: 11,
    no_timeline_event: 12,
    reporter_replaced: 13,
    reporter_withdrawn: 14,
    reporter_self_closed: 15,
    not_planned: 16,
    non_bug_neutral: 17,
    duplicate_to_fixed_in_release: 18,
    fixed_in_release: 19,
