...
function closureStatusRank(status: string): number {
  return ({
    ...
    repro_requested: 24,
    linked_closing_pr_reachability_unknown: 25,
    related_merged_pr_reachability_unknown: 26,
    not_planned_related_merged_pr_reachability_unknown: 27,
    linked_closing_pr_closed_unmerged: 28,
    linked_closing_pr_not_merged: 29,
    not_planned_linked_pr_not_merged: 30,
    related_closed_unmerged_pr_context: 31,
    not_planned_related_closed_unmerged_pr_context: 32,
    external_repo_closing_pr_unscored: 33,
    related_merged_pr_reachable_context_without_fix_credit: 34,
    not_planned_related_merged_pr_reachable_context_without_fix_credit: 35,
    related_pr_without_release_fix: 36,
    not_planned_related_pr_without_release_fix: 37,
    closed_without_release_fix_proof: 38,
    no_code_proof: 39,
    no_timeline_event: 40,
    reporter_replaced: 41,
    reporter_withdrawn: 42,
    reporter_self_closed: 43,
    non_bug_fixed_after_release: 44,
    non_bug_fixed_not_in_scored_releases: 45,
    non_bug_fixed_in_later_release: 46,
    non_bug_linked_without_merge: 47,
    non_bug_linked_pr_open: 48,
    non_bug_linked_pr_closed_unmerged: 49,
    non_bug_duplicate_to_open_canonical: 50,
    non_bug_superseded_to_open_pr: 51,
    non_bug_duplicate_with_open_pr_context: 52,
    non_bug_duplicate_to_fixed_after_release: 53,
    non_bug_duplicate_to_closed_canonical_missing_proof: 54,
    non_bug_duplicate_to_closed_canonical: 55,
    non_bug_duplicate_or_superseded: 56,
    non_bug_not_actionable: 57,
    not_planned: 58,
    non_bug_neutral: 59,
    non_bug_duplicate_to_fixed_in_release: 60,
    non_bug_fixed_in_release: 61,
    not_planned_with_release_fix_proof: 62,
    duplicate_to_fixed_in_release: 63,
    fixed_in_release: 64,
