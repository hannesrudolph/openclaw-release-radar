...
function closureStatusRank(status: string): number {
  return ({
    ...
    duplicate_to_fixed_after_release: 9,
    not_planned_fixed_after_release: 10,
    related_merged_pr_not_reachable_context: 11,
    not_planned_related_merged_pr_not_reachable_context: 12,
    duplicate_related_merged_pr_not_reachable_context: 13,
    main_only_claim: 14,
    already_present_claim: 15,
    admin_not_planned_unverified: 16,
    admin_not_planned_no_context: 17,
    duplicate_to_closed_canonical_missing_proof: 18,
    duplicate_to_unverified_closed_canonical: 19,
    duplicate_to_known_not_in_release_canonical: 20,
    duplicate_to_open_pr_canonical: 21,
    duplicate_to_closed_canonical: 22,
    duplicate_to_non_actionable_canonical: 23,
    canonical_cycle_or_self_reference: 24,
    duplicate_or_superseded: 25,
    repro_requested: 26,
    insufficient_info: 27,
    linked_closing_pr_reachability_unknown: 28,
    related_merged_pr_reachability_unknown: 29,
    not_planned_related_merged_pr_reachability_unknown: 30,
    duplicate_related_merged_pr_reachability_unknown: 31,
    linked_closing_pr_closed_unmerged: 32,
    linked_closing_pr_not_merged: 33,
    not_planned_linked_pr_not_merged: 34,
    related_closed_unmerged_pr_context: 35,
    not_planned_related_closed_unmerged_pr_context: 36,
    duplicate_related_closed_unmerged_pr_context: 37,
    external_repo_closing_pr_unscored: 38,
    related_merged_pr_reachable_context_without_fix_credit: 39,
    not_planned_related_merged_pr_reachable_context_without_fix_credit: 40,
    duplicate_related_merged_pr_reachable_context_without_fix_credit: 41,
    related_pr_without_release_fix: 42,
    not_planned_related_pr_without_release_fix: 43,
    duplicate_related_pr_without_release_fix: 44,
    closed_without_release_fix_proof: 45,
    no_code_proof: 46,
    no_timeline_event: 47,
    reporter_replaced: 48,
    reporter_withdrawn: 49,
    reporter_self_closed: 50,
    non_bug_fixed_after_release: 51,
    non_bug_fixed_not_in_scored_releases: 52,
    non_bug_fixed_in_later_release: 53,
    non_bug_linked_without_merge: 54,
    non_bug_linked_pr_open: 55,
    non_bug_linked_pr_closed_unmerged: 56,
    non_bug_duplicate_to_open_canonical: 57,
    non_bug_superseded_to_open_pr: 58,
    non_bug_duplicate_with_open_pr_context: 59,
    non_bug_duplicate_related_merged_pr_not_reachable_context: 60,
    non_bug_duplicate_related_merged_pr_reachability_unknown: 61,
    non_bug_duplicate_related_closed_unmerged_pr_context: 62,
    non_bug_duplicate_related_merged_pr_reachable_context_without_fix_credit: 63,
    non_bug_duplicate_related_pr_without_release_fix: 64,
    non_bug_duplicate_to_fixed_after_release: 65,
    non_bug_duplicate_to_closed_canonical_missing_proof: 66,
    non_bug_duplicate_to_closed_canonical: 67,
    non_bug_duplicate_or_superseded: 68,
    non_bug_not_actionable: 69,
    not_planned: 70,
    non_bug_neutral: 71,
    non_bug_duplicate_to_fixed_in_release: 72,
    non_bug_fixed_in_release: 73,
    not_planned_with_release_fix_proof: 74,
    duplicate_to_fixed_in_release: 75,
    fixed_in_release: 76,
