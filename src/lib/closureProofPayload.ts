...
function closureStatusRank(status: string): number {
  return ({
    ...
    fixed_not_in_scored_releases: 4,
    fixed_in_later_release: 5,
    fixed_after_release: 6,
    duplicate_to_fixed_after_release: 7,
    not_planned_fixed_after_release: 8,
    main_only_claim: 9,
    already_present_claim: 10,
    admin_not_planned_unverified: 11,
    duplicate_to_closed_canonical_missing_proof: 12,
    duplicate_to_unverified_closed_canonical: 13,
    duplicate_to_known_not_in_release_canonical: 14,
    duplicate_to_open_pr_canonical: 15,
    duplicate_to_closed_canonical: 16,
    duplicate_to_non_actionable_canonical: 17,
    canonical_cycle_or_self_reference: 18,
    duplicate_or_superseded: 19,
    repro_requested: 20,
    linked_closing_pr_reachability_unknown: 21,
    linked_closing_pr_not_merged: 22,
    not_planned_linked_pr_not_merged: 23,
    related_pr_without_release_fix: 24,
    not_planned_related_pr_without_release_fix: 25,
    closed_without_release_fix_proof: 26,
    no_code_proof: 27,
    no_timeline_event: 28,
    reporter_replaced: 29,
    reporter_withdrawn: 30,
    reporter_self_closed: 31,
    non_bug_fixed_after_release: 32,
    non_bug_fixed_not_in_scored_releases: 33,
    non_bug_fixed_in_later_release: 34,
    non_bug_linked_without_merge: 35,
    non_bug_duplicate_to_open_canonical: 36,
    non_bug_superseded_to_open_pr: 37,
    non_bug_duplicate_with_open_pr_context: 38,
    non_bug_duplicate_to_fixed_after_release: 39,
    non_bug_duplicate_to_closed_canonical_missing_proof: 40,
    non_bug_duplicate_to_closed_canonical: 41,
    non_bug_duplicate_or_superseded: 42,
    non_bug_not_actionable: 43,
    not_planned: 44,
    non_bug_neutral: 45,
    non_bug_duplicate_to_fixed_in_release: 46,
    non_bug_fixed_in_release: 47,
    not_planned_with_release_fix_proof: 48,
    duplicate_to_fixed_in_release: 49,
    fixed_in_release: 50,
